  ...
  useEffect(() => {
    ...
    const initUniverse = () => {
      ...
      starsRef.current = Array.from({ length: STAR_COUNT }, () => {
        ...
        if (colorWeight > 0.8) color = "rgba(165, 243, 252, "; // Cyan
        else if (colorWeight > 0.6) color = "rgba(196, 181, 235, "; // Purple/Indigo
      ...
      // Init planets (Solar system motion)
      planetsRef.current = [
      ...
      // Init galaxies (rotating clusters)
    ...
    const animate = () => {
      ...
      // 1. Draw Nebulas/Background Glow
      ...
      for (let i = 0; i < stars.length; i++) {
        ...
        // Draw connections (only for bright/nearby stars)
        if (s.z > 2.5) {
